...
|| (course.courseOwner.userId == user.userId && course.courseState != "FINISHED")>
...
<#if course?? && course.courseOwner.userId == user.userId && course.courseState == "FINISHED">
    <form class="form-horizontal" method="post"
          action="${rc.getContextPath()}/courses/${course.courseId}/notify">
        <fieldset>
            ...
            <div class="form-actions">
                <button id="deleteButton" class="btn btn-danger" type="submit">Notify</button>
