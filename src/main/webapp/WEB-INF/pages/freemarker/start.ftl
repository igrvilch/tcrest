...
|| (course.courseOwner.userId == user.userId && course.courseState != "READY")>
...
<#if course?? && course.courseOwner.userId == user.userId && course.courseState == "READY">
    <form class="form-horizontal" method="post"
          action="${rc.getContextPath()}/courses/${course.courseId}/start">
        <fieldset>
            ...
            <div class="form-actions">
                <button id="deleteButton" class="btn btn-danger" type="submit">Start</button>
