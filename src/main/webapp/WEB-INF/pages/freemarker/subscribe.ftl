...
course.subscribers?seq_contains(user.userEmail) || course.attenders?seq_contains(user.userEmail) || course.evaluators?seq_contains(user.userEmail)>
...
(course.courseState == "NEW" || course.courseState == "OPEN" || course.courseState == "READY") &&
!course.subscribers?seq_contains(user.userEmail) && !course.attenders?seq_contains(user.userEmail) && !course.evaluators?seq_contains(user.userEmail)>
    <form class="form-horizontal" action="${rc.getContextPath()}/courses/${course.courseId}/subscribe" method="post">
        <fieldset>
